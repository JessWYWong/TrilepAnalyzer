...
input = '/user_data/rsyarif/optimization_reMiniAOD_PRv9_FRv30CR2_newRunH_correctedMuTrkSF_AllSys_2017_7_14/lep1Pt0_jetPt0_MET20_NJets3_NBJets1_HT0_ST0_mllOS20/Shape_accurateLHESys_FRsysMar28_newSigSF_AsymmFRsys/templates_HTrebinned_TTM1000_bW0p5_tZ0p25_tH0p25_35p867fb.root'
...
#         else:
#         	#increase by 2x
#             try: model.add_lognormal_uncertainty('FRsys',math.log(1.40),proc,'triLepMMM')
#             except RuntimeError: pass
#             try: model.add_lognormal_uncertainty('FRsys',math.log(1.24),proc,'triLepEMM')
#             except RuntimeError: pass
