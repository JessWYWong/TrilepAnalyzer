...
#            except RuntimeError: pass
            ...
            try: model.add_lognormal_uncertainty('elIsoSys', math.log(1.045), proc, 'triLep2017EEE')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('elIsoSys', math.log(1.030), proc, 'triLep2017EEM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('elIsoSys', math.log(1.015), proc, 'triLep2017EMM')
            except RuntimeError: pass

            try: model.add_lognormal_uncertainty('elRecoSys', math.log(1.03), proc, 'triLep2017EEE')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('elRecoSys', math.log(1.02), proc, 'triLep2017EEM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('elRecoSys', math.log(1.01), proc, 'triLep2017EMM')
            except RuntimeError: pass

            try: model.add_lognormal_uncertainty('muIdSys', math.log(1.02), proc, 'triLep2017EEM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('muIdSys', math.log(1.04), proc, 'triLep2017EMM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('muIdSys', math.log(1.06), proc, 'triLep2017MMM')
            except RuntimeError: pass

            try: model.add_lognormal_uncertainty('muIsoSys', math.log(1.015), proc, 'triLep2017EEM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('muIsoSys', math.log(1.030), proc, 'triLep2017EMM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('muIsoSys', math.log(1.045), proc, 'triLep2017MMM')
            except RuntimeError: pass
 ...
 #           except RuntimeError: pass
            ...
            try: model.add_lognormal_uncertainty('lumiSys', math.log(1.023), proc, '*')
            except RuntimeError: pass
...
#             except RuntimeError: pass
        ...
        else: #From ttbcar closure + (data-MC)/ddbkg for FRv4_uFR Aug 2020  (updated by Jess)
            
            try: model.add_lognormal_uncertainty('FRsys',math.log(1.158),proc,'triLep2017MMM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('FRsys',math.log(1.030),proc,'triLep2017EMM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('FRsys',math.log(1.144),proc,'triLep2017EEM')
            except RuntimeError: pass
            try: model.add_lognormal_uncertainty('FRsys',math.log(1.257),proc,'triLep2017EEE')
            except RuntimeError: pass
            

            try: model.add_asymmetric_lognormal_uncertainty('muFReta',math.log(1.00),math.log(1.328),proc,'triLep2017MMM')
            except RuntimeError: pass
            try: model.add_asymmetric_lognormal_uncertainty('muFReta',math.log(1.00),math.log(1.153),proc,'triLep2017EMM')
            except RuntimeError: pass
            try: model.add_asymmetric_lognormal_uncertainty('muFReta',math.log(1.00),math.log(1.082),proc,'triLep2017EEM')
            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('muFReta',math.log(1.33),proc,'triLep2017MMM')
#            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('muFReta',math.log(1.15),proc,'triLep2017EMM')
#            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('muFReta',math.log(1.08),proc,'triLep2017EEM')
#            except RuntimeError: pass

            try: model.add_asymmetric_lognormal_uncertainty('muPRsys',math.log(1.00),math.log(1.066),proc,'triLep2017MMM')
            except RuntimeError: pass
            try: model.add_asymmetric_lognormal_uncertainty('muPRsys',math.log(1.00),math.log(1.015),proc,'triLep2017EMM')
            except RuntimeError: pass
            try: model.add_asymmetric_lognormal_uncertainty('muPRsys',math.log(1.00),math.log(1.010),proc,'triLep2017EEM')
            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('muPRsys',math.log(1.07),proc,'triLep2017MMM')
#            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('muPRsys',math.log(1.02),proc,'triLep2017EMM')
#            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('muPRsys',math.log(1.01),proc,'triLep2017EEM')
#            except RuntimeError: pass

            try: model.add_asymmetric_lognormal_uncertainty('elPRsys',math.log(1.00),math.log(1.066),proc,'triLep2017EEE')
            except RuntimeError: pass
            try: model.add_asymmetric_lognormal_uncertainty('elPRsys',math.log(1.00),math.log(1.028),proc,'triLep2017EEM')
            except RuntimeError: pass
            try: model.add_asymmetric_lognormal_uncertainty('elPRsys',math.log(1.00),math.log(1.010),proc,'triLep2017EMM')
            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('elPRsys',math.log(1.07),proc,'triLep2017EEE')
#            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('elPRsys',math.log(1.03),proc,'triLep2017EEM')
#            except RuntimeError: pass
#            try: model.add_lognormal_uncertainty('elPRsys',math.log(1.01),proc,'triLep2017EMM')
#            except RuntimeError: pass
