...
# 		cut+=' && (AllLeptonIsTight_PtOrdered[0]==1 && AllLeptonIsTight_PtOrdered[1]==1 && AllLeptonIsTight_PtOrdered[2]==1)'
	...
	if 'Data' in process: 
		...
		weightStr           = 'TrigEffWeight  * pileupWeight * L1NonPrefiringProb_CommonCalc * 1 * isoSF * lepIdSF * EGammaGsfSF * MuTrkSF * '+str(weight[process])
