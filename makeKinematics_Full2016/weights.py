...
nRun['TTWq'] = 1e-10 #from ? - # calculated using WeightAnalyzer. 
nRun['TTZl'] = 927976. #from 1992440 - # calculated using WeightAnalyzer. 
nRun['TTZq'] = 1e-10 #from ? - # calculated using WeightAnalyzer. 
