...
plotList += ['lepPtRebinned', 'lepPtRebinnedv1', 'lepPtRebinnedv3','STrebinnedv3','HTrebinnedv2','Mu1Pt','Mu1PtRebinned']
plotList += ['DeepCSV','DRJet12']
...
#			else: pullLegend.AddEntry(pullUncBandTot , "Bkg stat. #oplus syst." , "f")
		...
		if blind == False and doRealPull:
			...
			formatLowerHist(pull)
			if 'CR' in templateDir and 'ST' in discriminant:
				pull.SetAxisRange(hData.GetBinLowEdge(1),1399,"X")
			pull.Draw("HIST")
