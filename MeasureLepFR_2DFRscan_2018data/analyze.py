...
# 	cut += '   && ( ptRel_minDRlep3Jet > '+str(cutList['ptRelCut'])+'  || minDR_lep3Jet > '+str(cutList['minDRlepJetCut'])+' ) )' 
	...
	#if cutList['MuEtaCut'] > 0: cut += ' && ( (AllLeptonFlavor_PtOrdered[0]==1 && AllLeptonEta_PtOrdered[0]<'+str(cutList['MuEtaCut'])+') ||'
...
#End -- Method if isTTT exist
	...
	TrigEff = 'TrigEffWeight'
        ...
        if 'DataDrivenBkgTLT' in process and 'EERun2018A' in process: print "Applying Cuts: ", cut
	doDDBKGsys = False
