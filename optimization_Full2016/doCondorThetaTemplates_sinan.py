...
thisDir = os.getcwd()
relbase = '/home/ssagir/CMSSW_7_3_0/src/'
outputDir = thisDir+'/'
...
for conf in cutConfigs:
	...
	dict={'CMSSWBASE':relbase,'thisDir':thisDir,'lepPtCut':lepPtCut,'jet1PtCut':jet1PtCut,'jet2PtCut':jet2PtCut,
...
Log = condor.log
Notification = Error
Arguments = %(CMSSWBASE)s %(lepPtCut)s %(jet1PtCut)s %(jet2PtCut)s %(metCut)s %(njetsCut)s %(nbjetsCut)s %(jet3PtCut)s %(jet4PtCut)s %(jet5PtCut)s %(drCut)s %(Wjet1PtCut)s %(bjet1PtCut)s %(htCut)s %(stCut)s %(minMlbCut)s
