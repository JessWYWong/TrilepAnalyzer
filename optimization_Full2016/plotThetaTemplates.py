...
# 	savePrefix = templateDir.replace(cutString,'')+templateDir.split('/')[-2]+cutString+'/'+'plots/'
	...
	if doOneBand:
# 		c1.SaveAs(savePrefix+"_"+cutString+"totBand.pdf")
		c1.SaveAs(savePrefix+"_"+cutString+"totBand.png")
# 		c1.SaveAs(savePrefix+"_"+cutString+"totBand.root")
# 		c1.SaveAs(savePrefix+"_"+cutString+"totBand.C")
	else:
# 		c1.SaveAs(savePrefix+"_"+cutString+".pdf")
		c1.SaveAs(savePrefix+"_"+cutString+".png")
# 		c1.SaveAs(savePrefix+"_"+cutString+".root")
# 		c1.SaveAs(savePrefix+"_"+cutString+".C")
	try: del hTOP
	except: pass
	try: del hEWK
	except: pass
