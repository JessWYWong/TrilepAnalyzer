...
shutil.copyfile(thisDir+'/cutList_AllR.py', thisDir+'/cutList.py')
...
#		dict={'CMSSWBASE':relbase,'thisDir':thisDir,'dist':distribution,'cat':cat}
		...
		jdf.write(
"""universe = vanilla
Executable = %(thisDir)s/doCondorKinematics_AllR.sh
Should_Transfer_Files = YES
transfer_input_files = %(thisDir)s/doHists_AllR.py,%(thisDir)s/samples.py,%(thisDir)s/weights.py,%(thisDir)s/analyze.py,%(thisDir)s/cutList_AllR.py
