...
limitType = 'optimization_FWLJMET102X_3lep2017_wywong_012020_step1_FRv4_uFR_hadds_step2'
cutStr = 'NJets3_mllOS20_met20_isPassTrig_di1_nbjets1_ptRel8_bJet1Pt50_isPassTrilep1'
...
def add_systematics(cb):
	...
	#cb.cp().process(signal + allbkgs).channel(chnsAll).AddSyst(cb, 'muIdSys$ERA', 'lnN', ch.SystMap()(1.049))
	...
	#cb.cp().process(signal + allbkgs).channel(chnsAll).AddSyst(cb, 'elIsoSys$ERA', 'lnN', ch.SystMap()(1.036))
	...
	#cb.cp().process(signal + allbkgs).channel(chnsAll).AddSyst(cb, 'muIsoSys$ERA', 'lnN', ch.SystMap()(1.036))
	...
	#cb.cp().process(ddbkg).channel(chnsAll).AddSyst(cb, 'FRsys', 'lnN', ch.SystMap('era')(['2017'],1.04)(['2018'],1.02))

	#cb.cp().process(ddbkg).channel(chnsEEE).AddSyst(cb, 'elFR', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(ddbkg).channel(chnsEEM).AddSyst(cb, 'elFR', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(ddbkg).channel(chnsEMM).AddSyst(cb, 'elFR', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(ddbkg).channel(chnsEEM).AddSyst(cb, 'muFR', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(ddbkg).channel(chnsEMM).AddSyst(cb, 'muFR', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(ddbkg).channel(chnsMMM).AddSyst(cb, 'muFR', 'shape', ch.SystMap()(1.0))

	#cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'elTrig', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'muTrig', 'shape', ch.SystMap()(1.0))
	#cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'TrigEffWeight', 'shape', ch.SystMap()(1.0))
	...
	cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'jec$ERA', 'shape', ch.SystMap()(1.0))
        ...
        #cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'Tmis', 'shape', ch.SystMap()(1.0)) #
        #cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'Hmis', 'shape', ch.SystMap()(1.0)) #
        ...
        #else:
        #        cb.cp().process(allbkgs).channel(chns).AddSyst(cb, 'pdfNew', 'shape', ch.SystMap()(1.0))
	...
	#cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'muR' , 'shape', ch.SystMap()(1.0))
	#cb.cp().process(signal + allbkgs).channel(chns).AddSyst(cb, 'muF' , 'shape', ch.SystMap()(1.0))
...
if __name__ == '__main__':
	...
	rfile = fileDir+'/templates_'+discrim+'_'+BRconfStr+'_'+lumiStrDir+'_Combine.root'
	...
	chnsEEE = [chn for chn in chns if 'EEE' in chn]
        chnsEEM = [chn for chn in chns if 'EEM' in chn]
        chnsEMM = [chn for chn in chns if 'EMM' in chn]
        chnsMMM = [chn for chn in chns if 'MMM' in chn]
