...
name = limitdir.replace('limits_templates_','')+'InjR'+str(rInj)
...
'''
print 'Command = combine -M GenerateOnly -d '+filename+' --toysFrequentist --bypassFrequentistFit -t '+str(nToys)+' --saveToys --expectSignal '+str(rInj)+' -n '+name+' --setParameters '+masks
os.system('combine -M GenerateOnly -d '+filename+' --toysFrequentist --bypassFrequentistFit -t '+str(nToys)+' --saveToys --expectSignal '+str(rInj)+' -n '+name)
...
print 'Command = combine -M FitDiagnostics -d '+filename+' --robustFit=1 --skipBOnlyFit -t '+str(nToys)+' --toysFile higgsCombine'+name+'.GenerateOnly.mH120.123456.root --rMin '+str(rInj-10)+' --rMax '+str(rInj+10)+' -n '+name
os.system('combine -M FitDiagnostics -d '+filename+' --robustFit=1 --skipBOnlyFit -t '+str(nToys)+' --toysFile higgsCombine'+name+'.GenerateOnly.mH120.123456.root --rMin '+str(rInj-10)+' --rMax '+str(rInj+10)+' -n '+name)
